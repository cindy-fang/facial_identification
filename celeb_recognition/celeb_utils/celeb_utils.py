...
_ = ann_index.load(os.path.join(home,'/Users/as/OneDrive/Documents/project/celeb_recognition/celeb_index.ann'))

with open(os.path.join(home,'/Users/as/OneDrive/Documents/project/celeb_recognition/celeb_mapping.json')) as json_file:
